...
<div class="col-xs-12">
            ...
            <?php foreach ($productos as $producto) { ?>
                <tr>
					...
					<td><a class="btn btn-danger" href="<?php echo "eliminar.php?id=" . $producto->clave?>"> <img src="./imgmenu/eliminar.png" alt="imagen eliminar" width="50" height="50" /><i class="fa fa-trash"></i></a></td>
