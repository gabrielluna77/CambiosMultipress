...
<body>
     ...
     <table>
        ...
        <tr>
          ...
          <td bgcolor="#ffb759">Láminas en almacén:<?php echo $mostrar_op['suaje_alm'];?></td>
        </tr>
        <tr>
          <td bgcolor="#ffb759">Cliente:</td>
        ...
        <tr>
          ...
          <td bgcolor="#ffb759">Láminas en almacén:<?php echo $mostrar_op['suaje_alm1'];?></td>
        </tr>
        <tr>
          <td bgcolor="#ffb759">Cliente:</td>
        ...
        <tr>
          ...
          <td bgcolor="#ffb759">Láminas en almacén:<?php echo $mostrar_op['suaje_alm2'];?></td>
        </tr>
        <tr>
          <td bgcolor="#ffb759">Cliente:</td>
        ...
        <tr>
          ...
          <td bgcolor="#ffb759">Láminas en almacén:<?php echo $mostrar_op['suaje_alm3'];?></td>
        </tr>
