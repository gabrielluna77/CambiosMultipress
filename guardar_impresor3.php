...
$ssql = "update orden_alt set cliente3='$nombre_cliente', proveedor3='$nombre_prov', impresoras3='$nom_impresora', descrip_proce3_A='$pro_ce1', descrip_proce3_B='$pro_ce2', descrip_proce3_C='$pro_ce3', descrip_proce3_D='$pro_ce4', cant_laminas3='$can_la', laminas_alm3='$lam_alm', tamano3='$lam_tamano', suaje_alm3='$ti_suajes'  Where folio_op = '$esta_foliado'";
...
<div class="contenedor">
   ...
   <div>
   <form  method="post" action="respuesta_final.php" class="cbp-mc-form">
    <label for="res">SE TERMINÓ DE AGREGAR IMPRESORES</label>
    <input type="hidden" name="res" value="<?php echo "SI"; ?>" /> 
